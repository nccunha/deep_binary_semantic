...
epochs = 100
rgb_channels = 3
lr_start  = 0.00001 #0.0001
model_name='segnet' #segnet or deeplabv3
...
def main(log_file):
    ...
    train_dataloader_val = DataLoader(train_loader_val, batch_size=batch_size, shuffle=False)
    train_dataloader_esac = DataLoader(train_loader_esac, batch_size=batch_size, shuffle=False)
    ...
    for epo in tqdm(range(args.epoch_from, args.epoch_max+1)):
        ...
        f1_test = test_epoch(model, model_ndvi, model_name, train_dataloader_val)  
